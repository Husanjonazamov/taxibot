...
async def mail_success_task(callback_query: CallbackQuery, state: FSMContext):
    ...
    try:
        await bot.edit_message_reply_markup(
            ...
            reply_markup=buttons.group_mail_success_user(user_id, taxi_id, current_taxi_id)
        )
...
@dp.callback_query_handler(lambda callback_query: callback_query.data and callback_query.data.startswith("group_mail_success_"), state="*")
